...
#include "DBD_OnlineSubsystemUtils_structs.hpp"
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0388(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x038C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0390(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x03B0(0x0008) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x03B8(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ListenPort;                                               // 0x03A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0xA0];                                      // 0x03C0(0x00A0) MISSED OFFSET
...
{
public:
	class FString                                      BeaconTypeName;                                           // 0x0380(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0390(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x140];                                     // 0x03B0(0x0140) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x04F0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04F1(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x04F4(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x04F8(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
