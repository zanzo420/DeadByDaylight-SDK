...
#include "DBD_ScaleformUI_parameters.hpp"
...
// (Native, Public)
// Parameters:
// class FString                  InSwfAssetName                 (Parm, ZeroConstructor)
// bool                           bRefresh                       (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UGFxMoviePlayer::LoadAndStart(const class FString& InSwfAssetName, bool bRefresh)
{
	static auto fn = UObject::FindObject<UFunction>("Function ScaleformUI.GFxMoviePlayer.LoadAndStart");
