...
struct FEditableTextBoxStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 ForegroundColor;                                          // 0x0298(0x0028) (Edit, BlueprintVisible)
	struct FSlateColor                                 BackgroundColor;                                          // 0x02C0(0x0028) (Edit, BlueprintVisible)
	struct FSlateColor                                 ReadOnlyForegroundColor;                                  // 0x02E8(0x0028) (Edit, BlueprintVisible)
	struct FMargin                                     HScrollBarPadding;                                        // 0x0310(0x0010) (Edit, BlueprintVisible)
	struct FMargin                                     VScrollBarPadding;                                        // 0x0320(0x0010) (Edit, BlueprintVisible)
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x0330(0x0518) (Edit, BlueprintVisible)
};
...
struct FWindowStyle : public FSlateWidgetStyle
{
	...
	struct FTextBlockStyle                             TitleTextStyle;                                           // 0x0AA8(0x0150) (Edit, BlueprintVisible)
	struct FSlateBrush                                 ActiveTitleBrush;                                         // 0x0BF8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 InactiveTitleBrush;                                       // 0x0C88(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 FlashTitleBrush;                                          // 0x0D18(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 OutlineBrush;                                             // 0x0DA8(0x0090) (Edit, BlueprintVisible)
	struct FSlateColor                                 OutlineColor;                                             // 0x0E38(0x0028) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BorderBrush;                                              // 0x0E60(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BackgroundBrush;                                          // 0x0EF0(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 ChildBackgroundBrush;                                     // 0x0F80(0x0090) (Edit, BlueprintVisible)
};
...
// 0x0AE0 (0x0AE8 - 0x0008)
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	struct FEditableTextBoxStyle                       TextBoxStyle;                                             // 0x0008(0x0848) (Edit)
	struct FSlateFontInfo                              ActiveFontInfo;                                           // 0x0850(0x0040) (Edit)
	struct FSlateBrush                                 UpArrowImage;                                             // 0x0890(0x0090) (Edit)
	struct FSlateBrush                                 DownArrowImage;                                           // 0x0920(0x0090) (Edit)
	struct FSlateBrush                                 GlassImage;                                               // 0x09B0(0x0090) (Edit)
	struct FSlateBrush                                 ClearImage;                                               // 0x0A40(0x0090) (Edit)
	struct FMargin                                     ImagePadding;                                             // 0x0AD0(0x0010) (Edit)
	bool                                               bLeftAlignButtons;                                        // 0x0AE0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	struct FEditableTextBoxStyle                       EditableTextBoxStyle;                                     // 0x0008(0x0848) (Edit, BlueprintVisible)
	struct FTextBlockStyle                             TextStyle;                                                // 0x0850(0x0150) (Edit, BlueprintVisible)
};
...
struct FHyperlinkStyle : public FSlateWidgetStyle
{
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x02B0(0x0150) (Edit, BlueprintVisible)
	struct FMargin                                     Padding;                                                  // 0x0400(0x0010) (Edit, BlueprintVisible)
};
