...
#include "DBD_AnimNotify_AkEvent_structs.hpp"
...
{
public:
	class FString                                      Attach_Name;                                              // 0x0038(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	class FString                                      EventName;                                                // 0x0058(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
