...
#include "DBD_EngineSettings_structs.hpp"
...
public:
	...
	int                                                NumberOfPaksInInitialChunk;                               // 0x010C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                NumberOfPaksInAllChunks;                                  // 0x0110(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                LeftoverPakId;                                            // 0x0114(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TArray<struct FPathPak>                            PakAssignmentPaths;                                       // 0x0118(0x0010) (Edit, ZeroConstructor, Config)
