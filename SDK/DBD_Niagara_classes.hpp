...
#include "DBD_Niagara_structs.hpp"
...
{
public:
	class UNiagaraComponent*                           NiagaraComponent;                                         // 0x0380(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UNiagaraEffect*                              Asset;                                                    // 0x0610(0x0008) (ZeroConstructor, IsPlainOldData)
