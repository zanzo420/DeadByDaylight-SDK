...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0C8D(0x0003) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x0C90(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FSlateColor                                 ForegroundColor;                                          // 0x0CD0(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0CF8(0x0014) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnSelectionChanged;                                       // 0x0D08(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnOpening;                                                // 0x0D18(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x40];                                      // 0x0D28(0x0040) MISSED OFFSET
...
public:
	...
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x0420(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09A8(0x0014) (ZeroConstructor, InstancedReference)
	...
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x0A48(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0A50(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0A60(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0A70(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      bOverride_MinValue : 1;                                   // 0x0500(0x0001) (Edit)
	unsigned char                                      bOverride_MaxValue : 1;                                   // 0x0500(0x0001) (Edit)
	unsigned char                                      bOverride_MinSliderValue : 1;                             // 0x0500(0x0001) (Edit)
	unsigned char                                      bOverride_MaxSliderValue : 1;                             // 0x0500(0x0001) (Edit)
...
public:
	...
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x02F8(0x0010) (ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x0308(0x0010) (ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x0318(0x0010) (ZeroConstructor)
	unsigned char                                      bCanEverTick : 1;                                         // 0x0328(0x0001)
	unsigned char                                      bCanEverPaint : 1;                                        // 0x0328(0x0001)
...
{
public:
	class UClass*                                      WidgetClass;                                              // 0x0750(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0758(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0760(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0761(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0762(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0764(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LastWidgetRenderTime;                                     // 0x0768(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x076C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x076D(0x0003) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0770(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDrawAtDesiredSize;                                       // 0x0778(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0779(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x077C(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0784(0x0004) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0788(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0790(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x07A0(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x07B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EWidgetBlendMode>                      BlendMode;                                                // 0x07B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsOpaque;                                                // 0x07B5(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x07B6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x07B7(0x0001) MISSED OFFSET
	float                                              ParabolaDistortion;                                       // 0x07B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x07BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bUseLegacyRotation;                                       // 0x0830(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0831(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0832(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x5];                                       // 0x0833(0x0005) MISSED OFFSET
...
public:
	...
	float                                              InteractionDistance;                                      // 0x02B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EWidgetInteractionSource>              InteractionSource;                                        // 0x02BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x02BD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x02BE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x02BF(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x02C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x78];                                      // 0x02D0(0x0078) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x0348(0x0088) (Transient, IsPlainOldData)
	struct FVector2D                                   LocalHitLocation;                                         // 0x03D0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x03D8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	struct FHitResult                                  LastHitResult;                                            // 0x03E8(0x0088) (Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetInteractable;                             // 0x0470(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetFocusable;                                // 0x0471(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetHitTestVisible;                           // 0x0472(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0xD];                                       // 0x0473(0x000D) MISSED OFFSET
